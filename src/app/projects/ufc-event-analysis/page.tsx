...
export default function UFCEventAnalysisPage() {
  return (
    <div className="py-8">
      <Head>
        <title>UFC Event Analysis - Where &amp; When to Fight Next</title>
        <link rel="stylesheet" href="/assets/projects/styles.css" />
        <meta charSet="utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
      </Head>

      <h1>Maximize the Octagon: Where &amp; When to Fight Next</h1>
      ...
      <div className="section">
        <h2>Where is Our Operational Focus?</h2>
        <ul>
        ...
        <iframe src="/assets/projects/plots/regions_by_nb_events.html" width="100%" height="600px"></iframe>
      </div>

      <div className="section">
        <h2>Operational Focus - Where Do We Fight Most?</h2>
        <ul>
        ...
        <iframe src="/assets/projects/plots/top_and_bottom_regions_by_nb_events.html" width="100%" height="600px"></iframe>
      </div>

      <div className="section">
        <h2>Performance Trade-Offs: Attendance vs. Buyrate</h2>
        <ul>
        ...
        <iframe src="/assets/projects/plots/attendance_vs_buyrate.html" width="100%" height="600px"></iframe>
      </div>

      <div className="section">
        <h2>The Calendar Effect - When is the Best Time to Fight?</h2>
        <ul>
        ...
        <iframe src="/assets/projects/plots/buyrate_and_attendance_by_month.html" width="100%" height="600px"></iframe>
      </div>

      <div className="section">
        <h2>Overall Synthesis &amp; Key Actionable Insights</h2>
        <ul>
      ...
      <div className="section">
        <h2>The Big Question Answered</h2>
        <p>
